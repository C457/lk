...
int		DISK_ReadSector(int drv_type, int lun, unsigned long lba_addr, unsigned long nSector, void *buff);
...
typedef enum
{
	...
	DEV_BOOTCODE_CA7_READ_PAGE,			 	// Triflash (ONLY)
	DEV_BOOTCODE_CA7_WRITE_PAGE,			// Triflash (ONLY)
