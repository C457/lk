...
#define BOOTCONFIG_HIGH_SPEED		(1<<2)
#define BOOTCONFIG_NORMAL_SPEED		0

#define BOOTCONFIG_1BIT_BUS		0
#define BOOTCONFIG_4BIT_BUS		(1<<0)
#define BOOTCONFIG_8BIT_BUS		(1<<1)
...
#define BOOTSD_HIDDEN0_PAGESIZE			1*1024*2				// 1MB (= 1*1024*1024/512)
#define BOOTSD_HIDDEN1_PAGESIZE			1*1024*2				// 1MB (= 1*1024*1024/512)
#else
...
#define BOOTSD_HIDDEN2_PAGESIZE			8*1024*2				// 8MB  (= 8*1024*1024/512)
#else
#define BOOTSD_HIDDEN2_PAGESIZE			0					// 0MB  (= 1*1024*1024/512)
#endif
#endif
