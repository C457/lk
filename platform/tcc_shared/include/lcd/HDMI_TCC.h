...
//--------------------------------------------------------------------
#ifdef HDMI_960_1280
#define HDMI_VIDEO_MODE_TYPE	(0)
#else
#define HDMI_VIDEO_MODE_TYPE	(15)
#endif
    /*------+------------------+-----------------------+-----------------+
    ...
    |  [15] | v1920x720p_60Hz  | HDMI_PIXEL_RATIO_4_3  | 1920   |  720   |
...
//--------------------------------------------------------------------
#define HDMI_MODE_TYPE		(0)		// 0 : DVI mode, 1 : HDMI mode
