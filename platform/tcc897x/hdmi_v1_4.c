...
static const unsigned char hdmi_phy_config[][3][32] =
{
	...
	/* 94MHz - real 94.00226MHz */
	// TMDS Data Amplitude[4:0] : (Reg40 Bit<3:0>, REG3C Bit<7>), TMDS Clock Amplitude[3:0] : (Reg5C Bit<7:3>), TMDS Pre-emphasis Control : (Reg40 Bit<7:4>)
        //0x04,0x08,0x0C,0x10,0x14.0x18,0x1C,0x20,0x24,0x28,0x2C,0x30,0x34,0x38,0x3C,0x40,0x44,0x48,0x4C,0x50,0x54,0x58,0x5C,0x60,0x64,0x68,0x6C,0x70,0x74,0x78,0x7C,0x80
	{
           {0xD1,0x27,0x11,0x40,0x03,0x01,0xC8,0x81,0xE8,0xEB,0xD8,0x45,0xA0,0xAC,0x80,0x08,0x80,0x09,0x84,0x05,0x02,0x24,0x86,0x54,0x83,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
           {0xD1,0x27,0x11,0x40,0x03,0x01,0xC8,0x81,0xE8,0xEB,0xD8,0x45,0xA0,0xAC,0x80,0x08,0x80,0x09,0x84,0x05,0x02,0x24,0x86,0x54,0x83,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
           {0xD1,0x27,0x11,0x40,0x03,0x01,0xC8,0x81,0xE8,0xEB,0xD8,0x45,0xA0,0xAC,0x80,0x08,0x80,0x09,0x84,0x05,0x02,0x24,0x86,0x54,0x83,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
        },
#if 0//defined(INCLUDE_DDR900)/* 98.5MHz - real 98.50237 */
         // TMDS Data Amplitude[4:0] : (Reg40 Bit<3:0>, REG3C Bit<7>), TMDS Clock Amplitude[3:0] : (Reg5C Bit<7:3>), TMDS Pre-emphasis Control : (Reg40 Bit<7:4>)
         //0x04,0x08,0x0C,0x10,0x14.0x18,0x1C,0x20,0x24,0x28,0x2C,0x30,0x34,0x38,0x3C,0x40,0x44,0x48,0x4C,0x50,0x54,0x58,0x5C,0x60,0x64,0x68,0x6C,0x70,0x74,0x78,0x7C,0x80
         {
           {0xD1,0x29,0x12,0x40,0x0C,0x01,0xC8,0x87,0xE8,0xF6,0xD8,0x45,0xA0,0xAC,0x00,0x00,0x80,0x09,0x84,0x05,0x02,0x24,0x06,0x54,0x7D,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
           {0xD1,0x29,0x12,0x40,0x0C,0x01,0xC8,0x87,0xE8,0xF6,0xD8,0x45,0xA0,0xAC,0x00,0x00,0x80,0x09,0x84,0x05,0x02,0x24,0x06,0x54,0x7D,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
           {0xD1,0x29,0x12,0x40,0x0C,0x01,0xC8,0x87,0xE8,0xF6,0xD8,0x45,0xA0,0xAC,0x00,0x00,0x80,0x09,0x84,0x05,0x02,0x24,0x06,0x54,0x7D,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
         },
#else
	/* 98.5MHz - real 98.50237 */
        // TMDS Data Amplitude[4:0] : (Reg40 Bit<3:0>, REG3C Bit<7>), TMDS Clock Amplitude[3:0] : (Reg5C Bit<7:3>), TMDS Pre-emphasis Control : (Reg40 Bit<7:4>)
           {0xD1,0x29,0x10,0x40,0x2F,0x25,0xCB,0x83,0xE8,0xF9,0xD8,0x45,0xA0,0xAC,0x00,0x00,0x80,0x09,0x84,0x05,0x02,0x24,0x06,0x54,0xED,0x25,0x03,0x00,0x00,0x01,0x80,0x90},
           {0xD1,0x29,0x10,0x40,0x2F,0x25,0xCB,0x83,0xE8,0xF9,0xD8,0x45,0xA0,0xAC,0x00,0x00,0x80,0x09,0x84,0x05,0x02,0x24,0x06,0x54,0xED,0x25,0x03,0x00,0x00,0x01,0x80,0x90},
	},

	//97.34Mhz_strenth change
       {
           {0xD1,0x29,0x12,0x40,0x3C,0xCB,0xC8,0x87,0xE8,0xF3,0xD8,0x45,0xA0,0xAC,0x00,0x00,0x80,0x09,0x84,0x05,0x02,0x24,0x06,0x54,0x7E,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
           {0xD1,0x29,0x12,0x40,0x3C,0xCB,0xC8,0x87,0xE8,0xF3,0xD8,0x45,0xA0,0xAC,0x00,0x00,0x80,0x09,0x84,0x05,0x02,0x24,0x06,0x54,0x7E,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
           {0xD1,0x29,0x12,0x40,0x3C,0xCB,0xC8,0x87,0xE8,0xF3,0xD8,0x45,0xA0,0xAC,0x00,0x00,0x80,0x09,0x84,0x05,0x02,0x24,0x06,0x54,0x7E,0x24,0x01,0x00,0x00,0x01,0x80,0x90},
        },
...
//	{ 2080, 160 , 780,   60, 60  , 20 , 0, 2 , 1, 0,   0, 0,  0, 0, }        // v1920x720p_60H
	...
	{ 2080, 160 , 760,   40, 70  , 20 , 0, 18, 4, 0,   0, 0,  0, 0, },	/* v1920x720p_60Hz       PIXEL_FREQ_97_340, */
	{ 2162, 242 , 768,   48, 50  , 20 , 0, 15, 5, 0,   0, 0,  0, 0, },	/* v1920x720p_60Hz_12_3       PIXEL_FREQ_94, */
	{ 1440, 160 , 743,   23, 48  , 32 , 0, 5, 5, 0,   0, 0,  0, 0, },	/* v1280x720p_60Hz_8_0       PIXEL_FREQ_64, */
	{ 2080, 160 , 760,   40, 70  , 20 , 0, 18, 4, 0,   0, 0,  0, 0, },      /* v1920x720p_60Hz       PIXEL_FREQ_97_340_STR, */
...
//	{ PHY_FREQ_108_108       , PHY_FREQ_NOT_SUPPORTED, PHY_FREQ_NOT_SUPPORTED, },    // v1920x720p_60Hz
	...
	{ PHY_FREQ_97_340	, PHY_FREQ_NOT_SUPPORTED, PHY_FREQ_NOT_SUPPORTED, },
	{ PHY_FREQ_99_701       , PHY_FREQ_NOT_SUPPORTED, PHY_FREQ_NOT_SUPPORTED, },
	{ PHY_FREQ_64           , PHY_FREQ_NOT_SUPPORTED, PHY_FREQ_NOT_SUPPORTED, },
	{ PHY_FREQ_97_340_STR   , PHY_FREQ_NOT_SUPPORTED, PHY_FREQ_NOT_SUPPORTED, },
...
int hdmi_set_video_mode(const struct HDMIVideoParameter * const hdmi_video_mode)
{
	...
	switch(hdmi_video_mode->colorSpace) 
	{
		case HDMI_CS_RGB:		/** RGB color space */
			if (1)//hdmi_video_mode->resolution == v640x480p_60Hz)
