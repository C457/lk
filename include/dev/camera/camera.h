...
#define IOCTL_CM4_CTRL_OFF		    0
#define IOCTL_CM4_CTRL_ON			1
#define IOCTL_CM4_CTRL_RESET    	2
#define IOCTL_CM4_CTRL_CMD			3
#define IOCTL_CM4_CTRL_CHECK_STATUS 	4
...
extern int stopEarlyCamera(void);	// call by "target/tcc896x/init.c"
extern int startEarlyCamera(void);
extern int tcc_cif_close(void);
extern long tcc_cm4_ctrl_ioctl(unsigned int cmd, unsigned long arg);
