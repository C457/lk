...
#if (CONFIG_WATCHDOG_TIMEOUT * TCCWDT_CNT_MASK_UNIT > WDT_CNT_MASK )
#define QB_WATCHDOG_TIMEOUT 10
#else
#define QB_WATCHDOG_TIMEOUT CONFIG_WATCHDOG_TIMEOUT
#endif
...
//	reg_set(pmu_reg + PMU_SYSRST, 0x1 << 4); // Reset Output Signal
	...
	wdt_cont = QB_WATCHDOG_TIMEOUT*TCCWDT_CNT_MASK_UNIT;
