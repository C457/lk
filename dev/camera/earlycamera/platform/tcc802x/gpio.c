...
static gpioregs GPIO_REGS[] = {
	...
	{ /* GPIO SD0 */
		...
		.func_select1	= GPIO_REG(0x274),
		.func_select2	= GPIO_REG(0x278),
		.func_select3	= GPIO_REG(0x27C),
	},
	{ /* GPIO H */
		.data		= GPIO_REG(0x400),
		.out_en		= GPIO_REG(0x404),
		.out_or		= GPIO_REG(0x408),
		.out_bic	= GPIO_REG(0x40C),
		.out_xor	= GPIO_REG(0x410),
		.strength0	= GPIO_REG(0x414),
		.strength1	= GPIO_REG(0x418),
		.pull_enable	= GPIO_REG(0x41C),
		.pull_select	= GPIO_REG(0x420),
		.in_en		= GPIO_REG(0x424),
		.in_type	= GPIO_REG(0x428),
		.slew_rate	= GPIO_REG(0x42C),
		.func_select0	= GPIO_REG(0x430),
		.func_select1	= GPIO_REG(0x434),
		.func_select2	= GPIO_REG(0x438),
		.func_select3	= GPIO_REG(0x43C),
	},
	{ /* GPIO K */
		.data		= GPIO_REG(0x440),
		.out_en		= GPIO_REG(0x444),
		.out_or		= GPIO_REG(0x448),
		.out_bic	= GPIO_REG(0x44C),
		.out_xor	= GPIO_REG(0x450),
		.strength0	= GPIO_REG(0x454),
		.strength1	= GPIO_REG(0x458),
		.pull_enable	= GPIO_REG(0x45C),
		.pull_select	= GPIO_REG(0x460),
		.in_en		= GPIO_REG(0x464),
		.in_type	= GPIO_REG(0x468),
		.slew_rate	= GPIO_REG(0x46C),
		.func_select0	= GPIO_REG(0x470),
		.func_select1	= GPIO_REG(0x474),
		.func_select2	= GPIO_REG(0x478),
		.func_select3	= GPIO_REG(0x47C),
	},
};
