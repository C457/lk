...
#define GPIO_PORTSD0	(7 << GPIO_REG_SHIFT)
#define GPIO_PORTH	(8 << GPIO_REG_SHIFT)
#define GPIO_PORTK	(9 << GPIO_REG_SHIFT)
...
#define GPIOH_MAX	11
#define GPIOK_MAX	31
#define GPIOSD_MAX	10

#define TCC_GFBA	(0)
#define TCC_GFBB	(TCC_GFBA + GPIOA_MAX + 1)
#define	TCC_GFBC	(TCC_GFBB + GPIOB_MAX + 1)
#define TCC_GFBD	(TCC_GFBC + GPIOC_MAX + 1)
#define TCC_GFBE	(TCC_GFBD + GPIOD_MAX + 1)
#define TCC_GFBF	(TCC_GFBE + GPIOE_MAX + 1)
#define TCC_GFBG	(TCC_GFBF + GPIOF_MAX + 1)
#define TCC_GFBH	(TCC_GFBG + GPIOG_MAX + 1)
#define TCC_GFBK	(TCC_GFBH + GPIOH_MAX + 1)
#define TCC_GFBSD	(TCC_GFBK + GPIOK_MAX + 1)
